# -*- coding: utf-8 -*-
"""OrbitGuard — technical report PDF.
...
OUT = str(ROOT / "OrbitGuard_Technical_Report.pdf")
W, H = A4
FW = W - 3.2 * cm
...
story += [
    ...
    bullets([
        ...
        "OrbitGuard is a research-grade system, not an operational CA service; the TraCSS dataset is a diagnostic, "
        "not a certification.",
    ]),
    Spacer(1, 10),
...
doc = SimpleDocTemplate(OUT, pagesize=A4, leftMargin=1.6 * cm, rightMargin=1.6 * cm,
                        ...
                        title="OrbitGuard — Technical Report")
doc.build(story)
print("built", OUT)
